...
public class DetailActivity extends AppCompatActivity {
    ...
    protected void onResume() {
        ...
        TextView nekretninaIndetifikator = (TextView) findViewById(R.id.nekretnine_indentifikator_unos);
        ...
        TextView nekretninaBrojTelefona = (TextView) findViewById(R.id.nekretnine_broj_telefona_unos);
